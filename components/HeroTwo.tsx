...
export function GlobeDemo() {
  const globeConfig = {
    ...
    rings: 1,
    maxRings: 3,
    initialPosition: { lat: 0, lng: 114.1694 },
    autoRotate: true,
    autoRotateSpeed: 0.5,
  };
  ...
  return (
        ...
        <div className="  w-2/3 absolute  sm:block hidden overflow-visible  mb-30 md:h-[70vh] ">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
          ...
          className="div"
        >
          <h2 className="text-center text-xl md:text-4xl font-bold overflow-visible text-white">
