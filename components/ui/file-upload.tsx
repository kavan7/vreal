    ...
    <div className="w-full border-dotted" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="relative z-20 font-lightest uppercase  text-neutral-400 dark:text-neutral-400 text-base mt-2">
          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            ...
            {!file && (
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40 bg-neutral-300 dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
...
export function GridPattern() {
  ...
  const rows = 11;
  return (
    <div className="flex bg-black-100 dark:bg-neutral-900 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
            ...
            <div
              ...
              className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ...
                  : "bg-black dark:bg-neutral-950 shadow-[0px_0px_1px_3px_rgba(0,0,0,1)_inset]"
              }`}
            />
          );
        })
